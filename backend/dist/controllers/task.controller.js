...
exports.addComment = exports.deleteTask = exports.updateTask = exports.getTaskById = exports.getTasks = exports.createTask = void 0;
...
const updateTask = async (req, res) => {
    try {
        ...
        const task = await Task_model_1.default.findByIdAndUpdate(id, { $set: updates }, { new: true, runValidators: true })
            .populate('assignedTo', 'firstName lastName email avatar')
            .populate('createdBy', 'firstName lastName email avatar');
        if (!task) {
            res.status(404).json({ message: 'Task not found' });
